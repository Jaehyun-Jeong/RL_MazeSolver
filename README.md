...
$$
R_{t+1} + \gamma \hat{v} (s_{t+1}, w) <br/>
= R_{t+1} + \gamma \mathbb{E} _{\pi} [G_{t+1} | s_{t+1}] <br/>
= R_{t+1} + \gamma \mathbb{E}_\pi \left[\displaystyle\sum_{k=0}^{\infty} \gamma^k R_{t+k+2} | s_{t+1} \right] <br/>
\approx R_{t+1} + \gamma \left( R_{t+2} + R_{t+2} + \cdots \right) <br/>
= G_t
$$
